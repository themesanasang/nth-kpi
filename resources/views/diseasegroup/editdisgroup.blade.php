...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">แก้ไข กลุ่มโรค</li>
    </ol>
</div>

 <div class="row">
    <div class="col-xs-12 col-md-10"><h1 id="content" class="bd-title">แก้ไข กลุ่มโรค</h1></div>
 ...
 <div class="row">
    ...
    {!! Form::open( array('route' => ['diseasegroup.update', Crypt::encrypt($diseasegroup['id'])], 'class' => '', 'method' => 'PATCH') ) !!}
        <div class="form-group">           
            ...
            @endif	
            <input type="text" class="form-control" name="disease" required="" placeholder=" กลุ่มโรค" value="{{ $diseasegroup->disease }}">
        </div>
        <div class="form-group">  
            <label for="detail"> รายละเอียด</label> 
            <textarea class="form-control" name="detail" rows="2">{{ $diseasegroup->detail }}</textarea>
        </div>
