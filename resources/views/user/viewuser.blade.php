...
<div class="row">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ url('department') }}">ผู้ใช้งาน</a></li>
        <li class="breadcrumb-item active">ข้อมูลผู้ใช้งาน</li>
    </ol>
</div>

 <div class="row">
    <div class="col-xs-12 col-md-10"><h1 id="content" class="bd-title">ข้อมูลผู้ใช้งาน {{ $user->fullname }}</h1></div>
 ...
 <div class="row">
    <div class="col-md-offset-3 col-md-6 col-center">
        <ul class="list-group">
            ...
            <li class="list-group-item"><span class="tag tag-info">ทีม:</span> {{ $user->team }}</li>
